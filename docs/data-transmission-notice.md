...
| `PLANNOTATOR_ENDPOINT` | Plannotator HTTP endpoint override; 기본값은 `https://plannotator.ai/api` |
| `PLANNOTATOR_OFFLINE=1` | Plannotator API key 없이 synthetic offline HITL 결과 사용 |
